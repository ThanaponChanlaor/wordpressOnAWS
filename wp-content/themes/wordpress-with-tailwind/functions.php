...
function theme_enqueue_styles(){
	wp_enqueue_style("tailwind-style", get_template_directory_uri().
	"/tailwind_output.css", array(), "1.0");
}

add_action("wp_enqueue_scrips", "theme_enqueue_styles");

function enqueue_aos() {
    wp_enqueue_style('aos-css', get_template_directory_uri() . '/lib/aos/aos.css', array(), '2.3.4');

    wp_enqueue_script('aos-js', get_template_directory_uri() . '/lib/aos/aos.js', array(), '2.3.4', true);
}
